      ...
      >
        ...
        <ul className="list-unstyled menu-categories" id="accordionExample">
          <li className="menu active">
            ...
            <ul
              className="submenu list-unstyled show collapse"
              id="dashboard"
          ...
          <li className="menu">
            ...
            >
              ...
              <li>
                <a href="./auth-boxed-2-step-verification.html" target="_blank">
                  {' '}
                  2 Step{' '}
                </a>
              </li>
              ...
              <li>
                <a href="./auth-cover-2-step-verification.html" target="_blank">
                  {' '}
                  2 Step Cover{' '}
                </a>
              </li>
          ...
          <li className="menu">
            ...
            >
              ...
              <li>
                ...
                <ul
                  className="list-unstyled sub-submenu collapse"
                  id="level-three"
              ...
              <div className="">
                ...
                <span className="badge badge-primary sidebar-label">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="feather feather-message-circle badge-icon"
                  >
